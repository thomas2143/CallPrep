...
Extract ALL dated events and return ONLY valid JSON, no markdown, no preamble:

{
  "account_name": "inferred or provided account name",
  "call_type": "QBR | Renewal | Check-in | Escalation",
  ...
  "timeline": [
    {
      "date": "date as written in notes, e.g. 14 Mar or 2024-03-14",
...
- Questions must be specific to THIS account, not generic CSM questions
- dont_forget must be the single most important thing — the thing that could make or break the call
